...
DEFAULT_DB_PATH = "crag/knowledge_db"
...
def create_db(files=DEFAULT_DB_PATH, persist_directory=DEFAULT_PERSIST_PATH, embeddings="bge"):
    """
    ...
    # 定义持久化路径
    persist_directory = 'crag/vector_db/chroma'
    # 加载数据库
